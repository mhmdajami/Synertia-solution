...
const translations = {
  en: {
    ...
    logoTagline: "ENGINEERING · AUTOMATION · INTEGRATION",
  ...
  fr: {
    ...
    logoTagline: "INGÉNIERIE · AUTOMATISATION · INTÉGRATION",
  ...
  it: {
    ...
    logoTagline: "INGEGNERIA · AUTOMAZIONE · INTEGRAZIONE",
    footer: "Ingegneria industriale, consegnata.",
  },
};

function Logo({ light = false, tagline }) {
  return (
    <a href="#top" className="group flex items-center gap-3" aria-label="Synertia Solutions home">
      ...
      <span className="hidden sm:block">
        ...
        />
        <span className={`mt-0.5 block text-center text-[6px] font-bold tracking-[0.19em] ${light ? "text-slate-400" : "text-steel"}`}>
          {tagline}
        </span>
      </span>
    </a>
    ...
    <div id="top" className="overflow-x-hidden">
      <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-ink/90 text-white backdrop-blur-xl">
        <div className="mx-auto flex h-[76px] max-w-7xl items-center justify-between px-5 lg:px-8">
          <Logo light tagline={t.logoTagline} />
