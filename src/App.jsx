    ...
    <div id="top" className="overflow-x-hidden">
      ...
      <main>
        <section className="relative flex min-h-[760px] items-center overflow-hidden bg-ink pt-[76px] text-white lg:min-h-[850px]">
          <img src="./engineering-hero.png" alt="" className="absolute inset-0 h-full w-full object-cover object-[68%_center]" />
          ...
          <div className="relative mx-auto w-full max-w-7xl px-5 py-24 lg:px-8">
            <div className="max-w-4xl">
              <p className="mb-7 flex items-center gap-3 text-xs font-bold uppercase tracking-[.25em] text-signal"><span className="h-px w-9 bg-signal" />{t.hero.eyebrow}</p>
              <h1 className="text-[clamp(3rem,7vw,6.4rem)] font-black leading-[.92] tracking-[-.055em]">
                {t.hero.lines[0]}<span className="block text-signal">{t.hero.lines[1]}</span>{t.hero.lines[2]}
              </h1>
              <p className="mt-8 max-w-2xl text-base leading-7 text-slate-300 sm:text-lg">{t.hero.copy}</p>
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                <a href="#contact" className="flex items-center justify-center gap-3 bg-blueprint px-7 py-4 text-sm font-extrabold hover:bg-signal">{t.cta}<ArrowRight size={17} /></a>
                <a href="#services" className="flex items-center justify-center gap-3 border border-white/30 bg-white/5 px-7 py-4 text-sm font-extrabold">{t.hero.services}<ArrowDown size={17} /></a>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            ...
            <div className="mt-14 grid gap-px bg-slate-200 md:grid-cols-2 lg:grid-cols-5">
              {t.services.cards.map(([title,copy],i) => {
                ...
                return <article key={title} className="group bg-white p-7 hover:bg-mist lg:p-8">
        ...
        <section id="process" className="scroll-mt-20 bg-navy py-24 text-white lg:py-32">
          <div className="mx-auto max-w-7xl px-5 lg:px-8">
            ...
            <div className="relative mt-16 grid gap-8 lg:grid-cols-5 lg:gap-0">
              ...
              {t.process.steps.map(([n,title,copy]) => <article key={n} className="relative lg:pr-8"><div className="relative z-10 mb-7 grid h-12 w-12 place-items-center border border-signal bg-navy font-mono text-xs font-bold text-signal">{n}</div><h3 className="text-lg font-extrabold">{title}</h3><p className="mt-3 text-sm leading-6 text-slate-400">{copy}</p></article>)}
            </div>
          </div>
        </section>
        ...
        <section id="about" className="scroll-mt-20 bg-white py-24 lg:py-32">
          <div className="mx-auto grid max-w-7xl gap-14 px-5 lg:grid-cols-2 lg:items-center lg:px-8">
            <div className="relative min-h-[390px] overflow-hidden bg-ink p-8">
              <div className="technical-grid absolute inset-0 opacity-20" />
              <div className="relative grid h-full min-h-[326px] place-items-center">
                <div className="relative grid h-52 w-52 place-items-center rounded-full border border-signal/40">
            ...
            <div><Heading eyebrow={t.about.eyebrow} title={t.about.title} /><p className="mt-7 text-lg leading-8 text-steel">{t.about.p1}</p><p className="mt-5 text-lg leading-8 text-steel">{t.about.p2}</p><p className="mt-6 border-l-2 border-signal pl-4 text-sm font-black uppercase tracking-[0.14em] text-ink">{t.about.coverage}</p><div className="mt-8 grid gap-3 sm:grid-cols-2">{t.about.points.map(item => <div key={item} className="flex items-center gap-3 text-sm font-bold"><span className="grid h-5 w-5 place-items-center bg-blueprint text-white"><Check size={13} /></span>{item}</div>)}</div></div>
          </div>
        </section>
        ...
        <section id="contact" className="scroll-mt-20 bg-ink py-24 text-white lg:py-32">
          <div className="mx-auto grid max-w-7xl gap-16 px-5 lg:grid-cols-[.85fr_1.15fr] lg:px-8">
            <div><Heading eyebrow={t.contact.eyebrow} title={t.contact.title} light /><p className="mt-6 max-w-md text-lg leading-8 text-slate-300">{t.contact.copy}</p>
